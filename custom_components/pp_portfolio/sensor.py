...
from .const import (
    DOMAIN, CONF_PATH, CONF_INCLUDE_DETAILS, CONF_ENABLE_LIVE_PRICES,
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback):
    ...
    enable_live = entry.data.get(CONF_ENABLE_LIVE_PRICES, False)
    coordinator = PPDataCoordinator(hass, path, enable_live_prices=enable_live)
